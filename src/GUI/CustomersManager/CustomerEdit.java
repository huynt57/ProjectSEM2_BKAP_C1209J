...
public class CustomerEdit extends CustomFrame {
    ...
    public CustomerEdit(String title, boolean visible, boolean undecorate, boolean resizeable, Dimension dimension, final String id) throws SQLException, ClassNotFoundException {
        ...
        System.out.println(name.getText().toString()+" "+phone.getText().toString()+"kfsjdhfdskjfh");
