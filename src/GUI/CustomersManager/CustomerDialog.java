...
public class CustomerDialog extends CustomFrame {

    public CustomerDialog(String title, boolean visible, boolean undecorate, boolean resizeable, Dimension dim, final String id) {
