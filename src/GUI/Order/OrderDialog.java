...
public class OrderDialog extends CustomFrame {

    public OrderDialog(String title, boolean visible, boolean undecorate, boolean resizeable, Dimension dim, final String id) {
