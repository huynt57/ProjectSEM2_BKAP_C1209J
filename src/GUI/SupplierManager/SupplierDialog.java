...
public class SupplierDialog extends CustomFrame {

    public SupplierDialog(String title, boolean visible, boolean undecorate, boolean resizeable, Dimension dim, final String id) {
