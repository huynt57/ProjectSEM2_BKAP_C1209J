...
public class MeasureDialog extends CustomFrame {

    public MeasureDialog(String title, boolean visible, boolean undecorate, boolean resizeable, Dimension dim, final String id) {
