...
public class CustomersPanel extends JPanel {
    ...
    public CustomersPanel(JPanel parentPanel, Point pos, Dimension d) throws SQLException, ClassNotFoundException {
        ...
        HintTextField search = new HintTextField(" Search customer", CustomFont.getFont(Configure.DEFAULT_FONT, Font.PLAIN, 12), new Point(d.width - 280, 70), new Dimension(200, 30), CustomersPanel.this, false);
        ...
        for (int i = 0; i < 50; i++) {
            customers.add(new Customer("" + i, "Name " + i, "Type" + i, "Address" + i, "Phone" + i));
        }
